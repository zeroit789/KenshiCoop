...
static void testSizes() {
    ...
    CHECK_EQ("sizeof(BountyPacket)",            sizeof(BountyPacket),            86); // v44: bounty/crime row
    ...
    CHECK_EQ("PROTOCOL_VERSION (v44: bounty/crime / PKT_BOUNTY)", (int)PROTOCOL_VERSION, 44);
}
...
// ---- 11. Bounty/crime authority + convergence (Wire.h pure decision logic) ------
// Locks the protocol-44 H2 witness-local rules WITHOUT a live engine (the engine
